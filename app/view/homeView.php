...
?>
    ...
    <body>
        <header class="container mw-50 d-flex justify-content-between mb-0">
            ...
            <div class="d-flex me-0 justify-content-between">
                <a class="align-top" href="logout.php"><button id="logout" class="btn btn-light align-top me-0">Log out</button></a>
            </div>
        </header>
        ...
        <div id="watchlist-form-container" class="">
            ...
            <form class="" id="form-watchlist" method="POST">
                ...
                <div class="input-group mb-3">
                    ...
                    <select class="custom-select mb-2 mr-sm-2 rounded-right rounded w-25" name="magnitude" id="alert-duration-magnitude">
